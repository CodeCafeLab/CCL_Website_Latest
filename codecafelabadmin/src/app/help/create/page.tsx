...
import { createHelpArticle } from "@/lib/helpApi";
      ...
      <div className="p-6 md:p-8 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Help Article</h1>
              <p className="text-gray-600">Add a new help article or FAQ</p>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea name="content" value={form.content} onChange={handleChange} required rows={8} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Help article content" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
              ...
              {/* Optional: Add image upload for help article (e.g., illustration) */}
              <div>
              ...
              <div className="flex items-center space-x-4 pt-6">
                ...
                <button type="submit" disabled={isLoading} className="flex items-center space-x-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50">
                  <FaSave />
                  <span>{isLoading ? "Creating..." : "Create Help Article"}</span>
                </button>
              </div>
            </form>
          </div>
