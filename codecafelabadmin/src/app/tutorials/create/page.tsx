          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea name="content" value={form.content} onChange={handleChange} required rows={8} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Tutorial content" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="url" name="video_url" value={form.video_url} onChange={handleChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="https://example.com/video.mp4" />
                  ...
                  {form.video_url && (
                    <video src={form.video_url} controls className="mt-2 h-24 rounded border w-full max-w-xs" />
                  )}
                </div>
                <div>
