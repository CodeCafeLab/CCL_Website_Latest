            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="file"
                    accept=".pdf,.doc,.docx,.zip,.rar,.txt,.md,.js,.py,.java,.cpp,.c,.csv,.xls,.xlsx,.ppt,.pptx,.jpg,.jpeg,.png,.gif"
                    onChange={async (e) => {
                      ...
                      if (file) {
                        ...
                        const res = await fetch(
                          "https://api.cloudinary.com/v1_1/dubvzmk7g/auto/upload",
                          {
                            method: "POST",
                            body: formData,
                          }
                  ...
                  {form.file_url && (
                    <a
                      ...
                      className="block text-blue-600 mt-1 underline"
                    >
                      View Uploaded File
                    </a>
                  )}
