...
const WhitepapersPage: React.FC = () => {
  ...
  const handleEdit = (id: string) => {
    router.push(`/whitepapers/edit/${id}`);
  };
  ...
  return (
    <AdminLayout adminName="John Doe">
      <div className="p-6 md:p-8 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Manage your whitepapers and research documents
            </p>
          </div>
          <Link
            href="/whitepapers/create"
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search whitepapers by title or author..."
                  value={searchTerm}
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2 mb-3">
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(whitepaper.status)}`}>
                          {whitepaper.status}
                        </span>
                        {whitepaper.featured && (
                  ...
                  <div className="text-sm text-gray-600 mb-4">
                    <p><strong>Author:</strong> {whitepaper.author}</p>
                    <p><strong>Category:</strong> {whitepaper.category}</p>
                    <p><strong>Downloads:</strong> {whitepaper.download_count}</p>
                  </div>

                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => router.push(`/whitepapers/${whitepaper.id}`)}
                    ...
                    <button
                      onClick={() => handleEdit(whitepaper.id!)}
        ...
        {/* Empty State */}
        {!isLoading && filteredWhitepapers.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              {searchTerm || statusFilter !== "all"
                ...
                : "Get started by adding your first whitepaper."}
            </p>
            {!searchTerm && statusFilter === "all" && (
              <Link
                href="/whitepapers/create"
              ...
              >
                <FaPlus />
                <span>Add Your First Whitepaper</span>
              </Link>
            )}
          </div>
        )}
