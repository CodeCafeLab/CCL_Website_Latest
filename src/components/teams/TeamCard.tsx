  ...
  return (
    <Card className="group flex flex-col h-full overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1">
      ...
      <CardContent className="p-6 flex-grow flex flex-col items-center text-center">
        <CardTitle className="text-lg lg:text-xl mb-1 group-hover:text-primary transition-colors duration-300">
          {member.name}
        </CardTitle>
      ...
      <CardFooter className="p-4 pt-0 flex justify-center gap-4 border-t mt-auto">
        {member.linkedin_url && (
          <a href={member.linkedin_url} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg className="w-6 h-6 text-muted-foreground hover:text-primary transition-colors" fill="currentColor" viewBox="0 0 24 24">
