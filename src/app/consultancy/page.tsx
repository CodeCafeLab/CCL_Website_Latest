...
const industriesServed = [
  {
    ...
    icon: DollarSign,
    description:
      "Innovative solutions for financial institutions, enhancing security and user experience.",
  ...
  },
  {
    ...
    icon: Lightbulb,
    description:
      "Transforming healthcare with technology, improving patient care and operational efficiency.",
    image: "https://placehold.co/600x400.png",
  ...
  },
  {
    ...
    icon: BarChart3,
    description:
      "Optimizing supply chains and logistics operations with data-driven insights and automation.",
    image: "https://placehold.co/600x400.png",
  ...
  },
  {
    ...
    icon: MessageSquare,
    description:
      "Guiding startups from idea to launch with tailored tech strategies and MVP development.",
    image: "https://placehold.co/600x400.png",
  ...
  const onSubmit: SubmitHandler<ConsultancyFormData> = async (data) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || "Failed to submit consultancy request."
        );
      }
    ...
    <div className="space-y-16">
      <section className="text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Leverage our deep industry knowledge and technical expertise to
          navigate complex challenges and achieve your business objectives. We
          provide strategic guidance to help you innovate and grow.
        </p>
      </section>
      ...
      <section className="bg-card p-8 md:p-12 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-center mb-12">
          Benefits of Our Tech Consultancy
        </h2>
      ...
      <section>
        <Card className="max-w-2xl mx-auto shadow-xl border-2 border-primary/20">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Ready to discuss your project or challenges? Fill out the form
              below, and one of our expert consultants will get in touch with
              you shortly.
            </CardDescription>
          </CardHeader>
          <CardContent>
