...
const teamMembers = [
  { name: 'Gaurav Saini', role: 'Vibe Coder and business manager', image: '/gaurav.jpg', dataAiHint: 'male founder' },
  { name: 'Sarita Tak', role: 'Vibe Coder and business manager', image: '/sarita.jpg', dataAiHint: 'female founder' },
];
